...
public class LandCalculator {
	...
	// first consider number of parameter, it is same then consider type of variable, if they are same, that is a problem
	...
	public void landCalculator (int a, int b, int c) {
		int total2 = a + b + c; // here total2 is local variable
	...
	/*
	 ...
	 count number of parameters, if parameter number is same, 
